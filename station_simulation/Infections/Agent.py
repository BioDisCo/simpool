...
class Agent:
    ...
    def __init__(self, myid, mycat, myinfex):
        ...
        mycat -- category of the agent (Category)
    ...
    def infect(self, by_id: int, time: int):
        """
    ...
    def staff(self):
        """
        If agent is a healthcare worker (nurse, doctor, admin)
        """
        return self.category in [Category.NURSE, Category.DOCTOR, Category.ADMIN]
    ...
    def working(self):
        ...
        If agent works.
        """
        return self.symptoms is Symptoms.NONE and (not self.quarantined) and self.staff
    ...
    def sick_leave(self):
        ...
        """
        return self.symptoms in {Symptoms.MILD, Symptoms.SEVERE} and self.staff
